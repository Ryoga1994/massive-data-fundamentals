...
if sys.version < "3.4":
    raise RuntimeError("q4_python.py requires Pyton 3.4 or above")
...
def hadoop_nodes():
    ...
    import re
    (out, err) = subprocess.Popen(["yarn", "node", "-list"], stdout=subprocess.PIPE,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', help='input location', default='s3://gu-anly502/logs/forensicswiki.2012.txt')
    parser.add_argument('--mapper', help='mapper', default='q4_mapper.py')
    parser.add_argument('--reducer', help='reducer', default='q4_reducer.py')
    parser.add_argument('--streaming_jar', help='Specifies name of Hadoop streaming jar',
                        default='/usr/lib/hadoop/hadoop-streaming-2.7.3-amzn-1.jar')
